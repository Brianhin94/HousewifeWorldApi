        ...
        let content = salt.db.map((slcWives, i) => {
            return (
                <li className="slcWivesList" key={`slcWives-${i}`}> 
                    ...
                    <p className="wifeName">{slcWives.first_name} {slcWives.last_name}</p>
            ...
            <div className="city">
                ...
                <div className="vidIntroPanel">
                    ...
                    <div className="cityIntro">
                        <h2 className="welcomeCity"><b>Welcome to Salt Lake City, Bravo's latest introduction to the franchise in November of 2020.</b></h2>
